            ...
            dmc.Group(
                ...
                children=[
                    ...
                    dmc.Checkbox(id=ID.CHK_COMBINED, label="Combined PnL", checked=True, size="xs",
                                 styles={"label": {"color": "#E6EDF3", "fontSize": "12px"}}),
                    dmc.Checkbox(id=ID.CHK_BE_OPTIONS, label="Options B/E", checked=True, size="xs",
                                 styles={"label": {"color": "#2DD4BF", "fontSize": "12px"}}),
                    dmc.Checkbox(id=ID.CHK_BE_COMBINED, label="Combined B/E", checked=True, size="xs",
                                 styles={"label": {"color": "#F0B429", "fontSize": "12px"}}),
                ],
            ),
        ],
    )
